...
<div class="user" style="border: 2px solid">
        <h3>User Details</h3>
        <img src="{{ asset('images/kale.jpg') }}" alt="My Pigeon" width="200" height="200" style="border:2px none black; border-radius: 50%;">
...
<br>
    ...
    <div class="employee" style="border: 2px solid">
        ...
        <p>Join Date: {{ $e->date_of_joining->format('M d, Y')}} <b>That's like {{ $e->date_of_joining->diffForHumans()}}</b></p>
        <h4>Contacts</h4>
        <p>Main: {{ $e->phone}}</p>
