                        ...
                        <form method="POST" action="{{ route('assets.store') }}">
                            ...
                            <fieldset class="form-fieldset">
                                ...
                                <div class="form-row">
                                    <div class="form-col-12">
                                        <label for="serial_number" class="form-label form-label-required">Serial
                                            Number</label>
                                    ...
                                    <div class="form-col-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="purchase_cost" id="purchase_cost"
                                                class="form-control" value="{{ old('purchase_cost') }}" step="5"
                                                min="0" max="9999999">
                                        </div>
                                        @error('purchase_cost')
                                            <span class="form-error">{{ $message }}</span>
                                ...
                                <div class="form-row">
                                    <div class="form-col-12">
                                        ...
                                        <input type="date" name="warranty_until" id="warranty_until"
                                            class="form-control" value="{{ old('warranty_until') }}">
                            ...
                            <fieldset class="form-fieldset">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-col-6">
                                        <label for="current_condition" class="form-label form-label-required">Current
                                            Condition</label>
                                        <select name="current_condition" id="current_condition" class="form-select"
                                            required>
                                            <option value="">-- Select Condition --</option>
                                            @foreach (App\Enums\AssetConditions::cases() as $condition)
                                                <option value="{{ $condition->value }}"
                                                    {{ old('current_condition') == $condition->value ? 'selected' : '' }}>
                            ...
                            <fieldset class="form-fieldset">
                                ...
                                <div class="form-row">
                                    <div class="form-col-12">
                                        ...
                                        <textarea name="request_reason" id="request_reason" class="form-control" rows="3" maxlength="50">{{ old('request_reason') }}</textarea>
