        ...
        <div class="form-group">
            ...
            <select name="contract_type" id="contract_type" class="form-control" required>
                ...
                @foreach($contractTypes as $type)
                    <option value="{{ $type->value }}" {{ old('contract_type', $contract->contract_type) == $type->value ? 'selected' : '' }}>
        ...
        <div class="form-group">
            ...
            <select name="job_title" id="job_title" class="form-control" required>
                ...
                @foreach($jobTitles as $title)
                    <option value="{{ $title->value }}" {{ old('job_title', $contract->job_title) == $title->value ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <select name="contract_status" id="contract_status" class="form-control" required>
                        ...
                        @foreach($contractStatuses as $status)
                            <option value="{{ $status->value }}" {{ old('contract_status', $contract->contract_status) == $status->value ? 'selected' : '' }}>
